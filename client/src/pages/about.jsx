...
export default function About() {
  return (
    <div className="mt-8 flex flex-col items-center gap-8 md:mt-16 md:gap-24">
      <Title text="About" />
      <div className="flex flex-col items-center gap-8 md:flex-row md:gap-0 md:px-32">
        <img
          src={Restaurant}
          alt="restaurant-img"
          className="w-[70%] md:w-[390px]"
        />
        <p className="font-poppins text-white px-16 text-justify md:text-2xl">
      ...
      <div className="flex flex-col items-center gap-8 md:gap-0 md:flex-row-reverse md:justify-around">
        <img src={Dish} alt="meal-dish-img" className="w-[70%] md:w-[390px]" />
        <p className="glow font-bold text-xl px-8 text-center font-yellowtail md:text-5xl md:w-[50%]">
